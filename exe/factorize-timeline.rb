...
if __FILE__ == $0
	...
	loop do
		...
		rescue Net::ReadTimeout, Net::OpenTimeout, Errno::EHOSTUNREACH, Twitter::Error::Unauthorized, EOFError, Twitter::Error::ServiceUnavailable, Twitter::Error, Errno::ECONNRESET => e
			puts e.message
			puts e.backtrace
		end
